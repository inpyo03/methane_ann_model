...
연구 목적: 머신러닝 모델을 활용하여 소에게서 배출되는 메탄 발생량을 예측하는 모델 구축 <br>
연구 내용: 기본적인 통계방법인 MLR, 머신러닝 모델인 ML, ANN 모델을 활용하여 메탄 발생량을 예측하는 모델을 구축 및 적용
## Feature
데이터의 특성을 나타내는 것으로 데이터 표에서 열(Column)을 지칭한다.
![image](https://github.com/inpyo03/methane_ANN_modeling/assets/160727249/27889312-a6f6-4f62-b272-5b2b294164bc)
Feature라는 용어는 변수(variable)라는 용어로 자주 혼용되어 사용되고 있다.
### 연속형 변수 vs 범주형 변수
연속형 변수: 값이 연속된 변수 <br>
범주형 변수: 값이 보통 0 또는 1로 나타나는 변수
### 독립변수 vs 종속변수
![image](https://github.com/inpyo03/methane_ANN_modeling/assets/160727249/2025a018-4dbb-45ca-b8f0-67c56cb97a31)

독립변수: 연구자가 의도적으로 변화시키는 변수, 일반적으로 회귀식에서 X값을 의미한다. <br>
종속변수: 연구자가 독립변수의 변화에 따라 어떻게 변하는지 알고 싶어하는 변수, 일반적으로 회귀식에서 Y값을 의미한다.

### Machine Learning
![image](https://github.com/inpyo03/methane_ANN_modeling/assets/160727249/13bdad1c-3207-483d-bc10-17194076a581) <br>
기계학습: 컴퓨터 시스템이 데이터로부터 자동으로 학습하고 패턴을 인식하여 예측, 분류, 군집 등의 작업을 수행할 수 있는 인공지능 분야

### Regression vs Classification
![image](https://github.com/inpyo03/methane_ANN_modeling/assets/160727249/88ea49bb-578d-4f94-a125-b8b91cc4453d) <br>
Regression: 연속된 종속변수와 독립변수 사이의 관계를 규명한다. <br>
Classification: 범주형 종속변수와 독립변수 사이의 관계를 분석한다.
### Variance와 Bias
![variance와 bias](https://github.com/inpyo03/methane_ANN_modeling/assets/160727249/274261ba-8850-43a8-890e-caf7147e8c4f)
Variance(분산): 데이터 간의 퍼짐의 정도 <br>
Bias(편향): 중심으로부터 데이터의 치우침 정도 <br>
![image](https://github.com/inpyo03/methane_ANN_modeling/assets/160727249/e25a1ab6-f286-4e6a-b86e-ab3ccd16afc2) <br>
데이터를 적절한 분산 및 편향에 맞춰 설정하여야 오차를 최소화 할 수 있다.

### 분석 모식도
![그림1](https://github.com/inpyo03/methane_ANN_modeling/assets/160727249/ea5162f7-f060-432b-9d4d-77a54c6dffa5)
